    ...
    protected function register_style_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .mpdkit-cat-info h2' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .mpdkit-cat-info h2 a,{{WRAPPER}} .mpdkit-cat-info h2' => 'color: {{VALUE}};',
                ],
            ]
        );
