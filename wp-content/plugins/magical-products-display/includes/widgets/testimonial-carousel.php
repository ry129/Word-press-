	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'testimonial_name' => __('John Doe', 'magical-addons-for-elementor'),
						'testimonial_content' => __('Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio', 'magical-addons-for-elementor'),
						'testimonial_job' => __('Designer', 'magical-addons-for-elementor'),
						'link' => '',
					],
					[
						'testimonial_name' => __('John Doe', 'magical-addons-for-elementor'),
