...
class mgProduct_Accordion extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('MPD Accordion', 'magical-addons-for-elementor');
    }
    ...
    function register_content_controls()
    {
        $this->start_controls_section(
            'mpdac_item_section',
            [
                'label' => esc_html__('Accordion products', 'magical-addons-for-elementor'),
    ...
    protected function register_style_controls()
    {
        ...
        $this->start_controls_section(
            'mpdac_style_section',
            [
                'label' => esc_html__('Accordion Style', 'magical-addons-for-elementor'),
        ...
        $this->start_controls_section(
            'mpdac_title_style',
            [
                'label'     => esc_html__('Accordion Title Style', 'magical-addons-for-elementor'),
                'tab'     => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => esc_html__('Title Icon Style', 'magical-addons-for-elementor'),
                'tab'     => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => esc_html__('Products Content', 'magical-addons-for-elementor'),
                'tab'     => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'mpdac_cprice_color',
            [
                'label'         => esc_html__('Price Color', 'magical-addons-for-elementor'),
                'type'         => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
                ...
                ?>
                    ...
                    <?php else : ?>
                        <div class="alert alert-warning text-center mt-5 mb-5" role="alert">
                            <?php echo esc_html('No Products found. Please add products for display the accordion.', 'magical-posts-display'); ?>
                        </div>
                    <?php endif; ?>
                <?php endforeach; ?>
            <?php else : ?>
