	...
	<div class="mg-cols">
			...
			<div class="wel-center-text">
				...
				<div class="wel-sect-text">
					...
					<?php if (!class_exists('magicalPostDisplayPro')) : ?>
						<a href="https://wpthemespace.com/product/magical-posts-display-pro/" class="button button-mgp1 button-mgp2"><?php esc_html_e('Buy Pro Now', 'magical-post-display'); ?></a>
					<?php endif; ?>
				</div>
		...
		<section class="mgfeature mgf1">
			<div class="cols">
				...
				<div class="col-2">
					<div class="mgftext">
						<h2><?php esc_html_e('WordPress Elementor Posts Display Addons', 'magical-post-display'); ?></h2>
