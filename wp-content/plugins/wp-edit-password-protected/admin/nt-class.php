    ...
    <div class="mgadin-hero">
        <div class="mge-info-content">
            <div class="mge-info-hello">
                ...
                esc_html_e('Hello, ', 'wp-edit-password-protected');
            ...
            <div class="mge-info-desc">
                <div><?php echo esc_html('We hope you are enjoying using WP Edit Password Protected plugin for your WordPress website. If you find this plugin helpful, please consider leaving a review on our plugin page. Your review will help us improve our plugin and serve you better.', 'wp-edit-password-protected'); ?></div>
                <div class="mge-offer"><?php echo esc_html('Your Good feedback is valuable to us, and it helps us improve the plugin.', 'wp-edit-password-protected'); ?></div>
            </div>
            <div class="mge-info-actions">
                <a href="<?php echo esc_url($rev_link); ?>" target="_blank" class="button button-primary upgrade-btn">
                    <?php esc_html_e('Give A 5stars Review', 'wp-edit-password-protected'); ?>
                </a>
                <button class="button button-info wpepop-dedrev"><?php esc_html_e('Already Did', 'wp-edit-password-protected') ?></button>
                <button class="button button-info wpepop-dismiss"><?php esc_html_e('Don\'t Like This Plugin', 'wp-edit-password-protected') ?></button>
            </div>
...
{
    global $pagenow;
    if (get_option('wpeditpass_rev_added')) {
        return;
    }
    $hide_date = get_option('wpeditpass_revhide_date');
    if (!empty($hide_date)) {
...
function wp_edit_pass_new_optins_texts_init()
{
    if (isset($_GET['dismissed']) && $_GET['dismissed'] == 1) {
        update_option('wpeditpass_revhide_date', current_time('mysql'));
    }
    if (isset($_GET['revadded']) && $_GET['revadded'] == 1) {
        update_option('wpeditpass_rev_added', 1);
    }
}
