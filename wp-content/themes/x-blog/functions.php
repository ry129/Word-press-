 ...
 * @package x-blog
 */
$x_blog_theme = wp_get_theme();
if (!defined('X_BLOG_VERSION')) {
	// Replace the version number of the theme on each release.
	define('X_BLOG_VERSION', $x_blog_theme->get('Version'));
}
...
if (!function_exists('x_blog_setup')) :
	...
	function x_blog_setup()
	{
		...
		$x_blog_theme_install_date = get_option('x_blog_theme_install_date');
		if (empty($x_blog_theme_install_date)) {
			update_option('x_blog_theme_install_date', current_time('mysql'));
		}
...
if (is_admin() && ($xtheme_domain == 'x-blog' || $xtheme_domain == 'blog-x')) {
